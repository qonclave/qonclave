...
Run inside the geniex-env built by examples/hub/setup_hub.ps1, from the repo root:

    .\\examples\\hub\\geniex-env\\Scripts\\Activate.ps1
    ...
    python examples\\hub\\tests\\test_vlm.py           # uses demo.jpg, default prompt
    python examples\\hub\\tests\\test_vlm.py my_frame.jpg "Is a person present? What are they doing?"
