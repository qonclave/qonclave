...
Endpoints:
    ...
    GET/POST /user/sms-settings  outbound-SMS dashboard toggle (security app only)
    (all three live in apps/security/sms_routes.py, same `blueprints`
    mechanism -- none live here since they read Twilio's own wire shapes;
    see docs/CONVENTIONS.md's note on the sms_bus.py migration)
