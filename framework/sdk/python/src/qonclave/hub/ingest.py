"""
ingest.py — normalize inbound events from any transport, in any vocabulary.
...
Origin: hub/framework/adapter.py, which now re-exports this module.
Spec: spec/v1/json-schema/edge-event.schema.json
"""
...
from ..core.models import Command, EdgeEvent, MediaPayload

log = logging.getLogger("qonclave.hub.ingest")
