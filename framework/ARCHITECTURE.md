...
![Architecture Topology](ARCHITECTURE_assets/baseline.svg)  
*[Edit Topology in Excalidraw](ARCHITECTURE_assets/baseline.excalidraw)*
...
* **Triage (Tier 1 AI):** Runs ultra-lightweight, generalized heuristics (e.g., "Is there motion?" or "Is this a human shape?"). Its job is to filter out 99% of the noise so the network isn't flooded.
...
* **Heavy Lifting (Tier 2+ AI):** Executes large Vision-Language Models, LLMs, or complex aggregations.
